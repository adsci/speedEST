...
The Elastic Net model is a regression model that is a linear combination of t he Lasso and Ridge regression models, i.e., it uses both L1- and L2-norm regularization in the loss function:
